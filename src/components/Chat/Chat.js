...
export default class Chat extends Component {
    constructor(props) {
        ...
        WebSocketInstance.connect(this.props.currentUser, this.props.friendUser);
    ...
    renderMessages = (messages) => {
        ...
        return messages.map((message, i) => <li key={message.id}
                                                className={message.author === currentUser ? 'me' : 'him'}><h4
            className='author'>{message.author} </h4><p>{message.content}</p></li>);
    }
